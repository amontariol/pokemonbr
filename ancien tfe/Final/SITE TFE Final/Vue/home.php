    ...
    <div class='modal-dialog modal-login'>
      <div class='modal-content'>
        ...
        <div class='modal-body'>
          <form action='../Controleur/controleur_connexion.php' method='post'name='login'>
  ...
  <div id='myregisterModal' class='modal fade'>
    <div class='modal-dialog modal-login'>
      <div class='modal-content'>
        ...
        <div class='modal-body'>
          <form action='../Controleur/controleur_inscription.php' method='post' name='register'>
            <div class='form-group'>
            ...
            <div class='form-group'>
              <button type='submit' class='btn btn-primary btn-lg btn-block login-btn' onclick='verifemail(document.register.emailadress)'>Sign up</button>
            </div>
          </form>
        </div>
        <div class='modal-footer' id='modalcontainer'>
  ...
  <div class='container'>
    ...
    <div class='collapse navbar-collapse' id='navbarResponsive'>
      <ul class='navbar-nav text-uppercase ml-auto'>
        ...
        <li class='nav-item'>
          <a href='../Downloads/Pokeroyale.rar' class='nav-link'>Download the game</a>
        </li>
        <li class='nav-item'>
...
<!-- Stats -->
  ...
  <script>../js/verifemail.js'</script>
